...
def run(DEPTH):
    ...
    f = open('./Results/' + str(DEPTH) + ' deep results.txt', "w+")
    print('now running EMM depth', DEPTH)
    ...
    for n in range(N_SAMPLE_GAMES):
        ...
        resultFull = game.play_sample_game('./Results/' + 'Depth ' + str(DEPTH) + ' Sample Game '+ str(n+1), DEPTH, n+1)
